...
const Home = () => {
  const trustMetrics = [
    ...
    { value: '99.9%', label: 'Compliance Rating' },
  ];
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white p-6 rounded-lg">
                  ...
                  <div className="h-4 bg-gray-200 rounded-full overflow-hidden flex">
                    <div className="bg-korbly-blue h-full" style={{ width: '45%' }}></div>
                    <div className="bg-korbly-gold h-full" style={{ width: '30%' }}></div>
                    <div className="bg-korbly-silver h-full" style={{ width: '25%' }}></div>
                  </div>
