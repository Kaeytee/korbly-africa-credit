        ...
        <div className="max-w-4xl mx-auto">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus-enhanced"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(value) => handleChange('institutionType', value)}>
                        <SelectTrigger className="bg-white/10 border-white/20 text-white focus-enhanced">
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <div className="border-2 border-dashed border-white/20 rounded-lg p-6 text-center">
                      ...
                      <Button
                        variant="outline"
                        className="border-white text-white hover:bg-white hover:text-korbly-navy focus-enhanced"
                      >
                        Choose Files
                      </Button>
                    </div>
              ...
              <div className="flex flex-col sm:flex-row justify-between gap-4 pt-6">
                <Button
                  ...
                  className="border-white text-white hover:bg-white hover:text-korbly-navy focus-enhanced order-2 sm:order-1"
                >
                  Back
                </Button>
                ...
                <Button
                  onClick={handleNext}
                  disabled={isLoading}
                  className="bg-korbly-blue hover:bg-korbly-blue/90 text-white px-8 focus-enhanced order-1 sm:order-2"
                >
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-korbly-silver">
              ...
              <Link to="/login" className="text-korbly-blue hover:text-korbly-gold transition-colors font-medium focus-enhanced">
                Sign in here
              </Link>
            </p>
          </div>
