...
const Signup = () => {
  ...
  const stepTitles = ['Organization Details', 'User Information', 'Verification & Compliance', 'Account Setup'];
  const stepIcons = [Building, User, FileText, Settings];
  return <div className="min-h-screen bg-gradient-to-br from-korbly-navy via-korbly-dark to-korbly-navy relative overflow-hidden">
      {/* Animated Background */}
        ...
        <div className="max-w-1xl mx-auto">
            ...
            <CardContent className="p-6">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-4 gap-2">
                  ...
                  return <div key={index} className={`text-center p-2 rounded-lg transition-colors ${isActive ? 'bg-korbly-blue/20' : isCompleted ? 'bg-green-500/20' : 'bg-white/5'}`}>
                        <StepIcon className={`w-5 h-5 mx-auto mb-1 ${isActive ? 'text-korbly-blue' : isCompleted ? 'text-green-500' : 'text-gray-400'}`} />
                        <div className={`text-xs ${isActive ? 'text-white' : isCompleted ? 'text-green-500' : 'text-gray-400'}`}>
                          {title}
                        </div>
                      </div>;
                })}
          ...
          <Card className="glass border-white/20">
            <CardHeader>
              ...
              {currentStep === 1 && <p className="text-korbly-silver text-center">
                  Tell us about your organization and institutional requirements
                </p>}
              {currentStep === 2 && <p className="text-korbly-silver text-center">
                  Provide your professional contact information
                </p>}
              {currentStep === 3 && <p className="text-korbly-silver text-center">
                  Upload required documents and acknowledge compliance requirements
                </p>}
              {currentStep === 4 && <p className="text-korbly-silver text-center">
            ...
            <CardContent className="space-y-6">
              ...
              {currentStep === 1 && <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input required value={formData.companyName} onChange={e => handleChange('companyName', e.target.value)} placeholder="Enter institution name" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input required type="email" value={formData.primaryContact} onChange={e => handleChange('primaryContact', e.target.value)} placeholder="contact@institution.com" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
              ...
              {currentStep === 2 && <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input required value={formData.fullName} onChange={e => handleChange('fullName', e.target.value)} placeholder="Enter your full name" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                    
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-white">Title/Position *</label>
                      <Input required value={formData.title} onChange={e => handleChange('title', e.target.value)} placeholder="e.g., CIO, Portfolio Manager" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input required type="email" value={formData.workEmail} onChange={e => handleChange('workEmail', e.target.value)} placeholder="you@institution.com" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                    
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-white">Phone Number *</label>
                      <Input required value={formData.phone} onChange={e => handleChange('phone', e.target.value)} placeholder="+233 (0) 123 456 789" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input value={formData.department} onChange={e => handleChange('department', e.target.value)} placeholder="e.g., Investments, Risk" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start space-x-3">
                        <Checkbox id="compliance" checked={formData.complianceAcknowledged} onCheckedChange={checked => handleChange('complianceAcknowledged', checked as boolean)} />
                      ...
                      <div className="flex items-start space-x-3">
                        <Checkbox id="aml" checked={formData.amlCompliance} onCheckedChange={checked => handleChange('amlCompliance', checked as boolean)} />
              ...
              {currentStep === 4 && <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input required type="password" value={formData.password} onChange={e => handleChange('password', e.target.value)} placeholder="Create secure password" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                    
                    <div className="space-y-2">
                      <label className="text-sm font-medium text-white">Confirm Password *</label>
                      <Input required type="password" value={formData.confirmPassword} onChange={e => handleChange('confirmPassword', e.target.value)} placeholder="Confirm password" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input value={formData.securityAnswer} onChange={e => handleChange('securityAnswer', e.target.value)} placeholder="Enter your answer" className="bg-white/10 border-white/20 text-white placeholder:text-gray-400" />
                  </div>
                  
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <Checkbox id="2fa" checked={formData.twoFactorEnabled} onCheckedChange={checked => handleChange('twoFactorEnabled', checked as boolean)} />
                    ...
                    <div className="flex items-center space-x-3">
                      <Checkbox id="notifications" checked={formData.notifications} onCheckedChange={checked => handleChange('notifications', checked as boolean)} />
              ...
              <div className="flex justify-between pt-6">
                <Button variant="outline" onClick={handleBack} disabled={currentStep === 1} className="border-white text-white hover:bg-white hover:text-korbly-navy">
                  Back
                </Button>
                
                <Button onClick={handleNext} disabled={isLoading} className="bg-korbly-blue hover:bg-korbly-blue/90 text-white">
